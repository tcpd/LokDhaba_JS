...
export default class DataVisualization extends Component {
  ...
  fetchVisualizationData = () => {
    return new Promise((resolve, reject) => {
      ...
      const url = Constants.baseUrl + "/v1/getVizData";
      fetch(url, {
        method: "POST",
        headers: new Headers({
  ...
  fetchMapYearParties = () => {
    ...
    let visualization = this.state.visualization;
    let visualizationType = this.state.visualizationType;
    const url = Constants.baseUrl + "/v1/getMapYearParty";
    fetch(url, {
      method: "POST",
      headers: new Headers({
        "content-type": "application/json"
  ...
  fetchMapYearOptions = (searchYear) => {
    ...
    let visualization = this.state.visualization;
    let visualizationType = this.state.visualizationType;
    const url = Constants.baseUrl + "/v1/getMapYear";
    fetch(url, {
      method: "POST",
      headers: new Headers({
        "content-type": "application/json"
    ...
    return new Promise((resolve, reject) => {
      ...
      fetch(url, {
        ...
        resp.data.forEach(function (item) {
          const urlVizData = Constants.baseUrl + "/v1/getVizData";
          fetch(urlVizData, {
            method: "POST",
            headers: new Headers({
              "content-type": "application/json"
          ...
          const urlVizLegend = Constants.baseUrl + "/v1/getVizLegend";
          fetch(urlVizLegend, {
            method: "POST",
            headers: new Headers({
              "content-type": "application/json"
  ...
  fetchChartMapOptions = (state) => {
    ...
    const url = Constants.baseUrl + "/v1/getVizLegend";
    fetch(url, {
      method: "POST",
      headers: new Headers({
        "content-type": "application/json"

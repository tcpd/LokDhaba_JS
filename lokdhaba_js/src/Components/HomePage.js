    ...
    return (
      <div className="content overflow-auto">
        <div className="text-content">
          ...
          <p> We have recently updated Lok Dhaba with the results of the 2020 elections to the Delhi Vidhan Sabha. These results are provisional, and will be finalized once the Election

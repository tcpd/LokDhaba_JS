    ...
    return (
      <div className="content">
        <p> Welcome to Lok Dhaba!
            ...
            <p> We have recently updated Lok Dhaba with the results of the 2019 elections to the Lok Sabha
                and 4 Vidhan Sabhas. These results are provisional, and will be finalized once the Election
